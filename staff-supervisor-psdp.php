...
include("validate.php");
  ...
  if(isset($_POST['btnsub'])){
    ...
    $total_psdp = ($aims + $req + $stak + $reff + $elicit + $proto + $listofreq)/7;
    $_SESSION["sup_total_psdp"] = round((int)$total_psdp,2); 
  ...
  function email(){
    ...
    require("mail-script.php"); 
      ...
      if(empty($_SESSION['sup_total_psdp'])){
        $_SESSION["sup_total_psdp"] = 0;
      }
                                    ...
                                    <tr>
                                      <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 40px;"
                                        ...
                                        <p class="" style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;"
                                          ...
                                          Marked : Project PSDP <br>
                                          Role : Supervisor <br>
                                          Date & Time : '.$date.' <br>
                                          Total Report Marks : '.$_SESSION["sup_total_psdp"].' 
                                        </p>
                                        <table class="s-4 w-full" role="presentation" border="0" cellpadding="0"
                                          cellspacing="0" style="width: 100%;" width="100%">
                                          <tbody>
